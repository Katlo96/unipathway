...
const COLLEGES: College[] = [
  { id: '1', name: 'Botswana Accountancy College', location: 'Gaborone', tagline: 'Excellence in Business Education', badge: 'BAC' },
  { id: '2', name: 'Gaborone Universal College', location: 'Gaborone', tagline: 'Accessible Quality Education', badge: 'GUC' },
  { id: '3', name: 'ABM University College', location: 'Gaborone', tagline: 'Professional & Vocational Training', badge: 'ABM' },
  // Add more as needed
];
...
function CollegesContent() {
  ...
  const handleViewCollege = useCallback((id: string) => {
    router.push(`/student/college-details`);
  }, []);
            ...
            >
              ...
              <View style={styles.headerCenter}>
                ...
                <Text
                  ...
                  numberOfLines={1}
                >
                  Explore colleges across Botswana
                </Text>
              </View>
              <HeaderIconButton
                icon="search-outline"
                  ...
                  <View style={{ width: ui.railWidth }}>
                    <SurfaceCard colors={colors} elevation={elevation} style={{ padding: spacing(5) }}>
                      ...
                      <Text style={[typography.caption, { color: colors.textMuted, marginTop: spacing(2) }]}>
                        Search colleges, open details, and move through the student portal from the menu.
                      </Text>
                ...
                <View style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    <View style={[styles.heroRow, ui.isMobile ? styles.heroRowMobile : null]}>
                      <View style={{ flex: 1, minWidth: 0 }}>
                        <Text style={[typography.hero, { color: colors.text }]}>Find the right college</Text>
                        <Text
                          style={[
                            typography.body,
                            {
                        ...
                        >
                          Explore colleges, compare options, and open detailed pages for a deeper look.
                        </Text>
                      </View>
                      ...
                      >
                        {filtered.map((college) => (
                          <CollegeCard
                            ...
                            elevation={elevation}
                            minWidth={ui.gridMin}
                            onPress={() => handleViewCollege(college.id)}
                          />
                        ))}
                      </View>
                    )}
...
// ────────────────────────────────────────────────────────────────────────────────
// Reused components (identical to universities.tsx)
// ────────────────────────────────────────────────────────────────────────────────
  ...
  return (
    ...
    >
      <View style={styles.uniCardTop}>
        ...
        >
          <Text style={[styles.badgeText, { color: colors.primary }]}>{college.badge}</Text>
        </View>
        <View
          style={[
            styles.chevronWrap,
