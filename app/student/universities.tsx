...
function UniversitiesContent() {
  ...
  const handleViewUniversity = useCallback((id: string) => {
    router.push(`/student/university-details`);
  }, []);
                  ...
                  <View style={{ width: ui.railWidth }}>
                    <SurfaceCard colors={colors} elevation={elevation} style={{ padding: spacing(5) }}>
                      ...
                      <Text style={[typography.caption, { color: colors.textMuted, marginTop: spacing(2) }]}>
                        Search universities, open details, and move through the student portal from the menu.
                      </Text>
                      ...
                      <Text style={[typography.caption, { color: colors.textSoft, marginTop: spacing(4) }]}>
                        Tip: Search by institution name, city, or specialty to narrow results faster.
                      </Text>
                    </SurfaceCard>
                  </View>
                ) : null}
                ...
                <View style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    <View style={[styles.heroRow, ui.isMobile ? styles.heroRowMobile : null]}>
                      <View style={{ flex: 1, minWidth: 0 }}>
                        <Text style={[typography.hero, { color: colors.text }]}>Find the right university</Text>
                        <Text
                          style={[
                            typography.body,
                            {
                        ...
                        >
                          Explore institutions, compare options, and open detailed pages for a deeper look.
                        </Text>
                      </View>
  ...
  return (
    ...
    >
      <View style={styles.uniCardTop}>
        ...
        >
          <Text style={[styles.badgeText, { color: colors.primary }]}>{university.badge}</Text>
        </View>
        <View
          style={[
            styles.chevronWrap,
